  ...
  <div class="panel panel-default">
    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-up-theme">
        ...
        <div style="margin-top:10px; margin-bottom:25px;">
            ...
            <a href="http://support.321cart.com/system/" class="link" target="_blank">UP Support</a>
							...
							<div class="col-sm-10">
                                ...
                                <ul id="t1o_top_custom_block_content" class="nav nav-tabs">
									<?php foreach ($languages as $language) { ?>
										<li><a href="#t1o_top_custom_block_content_<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
									<?php } ?>
								</ul>
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-10">
                                ...
                                <ul id="t1o_menu_categories_custom_block_content" class="nav nav-tabs">
									<?php foreach ($languages as $language) { ?>
										<li><a href="#t1o_menu_categories_custom_block_content_<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
									<?php } ?>
								</ul>
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-10">
                                ...
                                <ul id="t1o_menu_custom_block_<?php echo $i; ?>" class="nav nav-tabs">
									<?php foreach ($languages as $language) { ?>
										<li><a href="#t1o_menu_custom_block_<?php echo $i; ?>_<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
									<?php } ?>
								</ul>
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-10">
                                ...
                                <ul id="t1o_custom_bar_below_menu_content" class="nav nav-tabs">
									<?php foreach ($languages as $language) { ?>
										<li><a href="#t1o_custom_bar_below_menu_content_<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
									<?php } ?>
								</ul>
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-10">
                                ...
                                <ul id="t1o_product_fb1_content" class="nav nav-tabs">
									<?php foreach ($languages as $language) { ?>
										<li><a href="#t1o_product_fb1_content_<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
									<?php } ?>
								</ul>
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-10">
                                ...
                                <ul id="t1o_product_fb2_content" class="nav nav-tabs">
									<?php foreach ($languages as $language) { ?>
										<li><a href="#t1o_product_fb2_content_<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
									<?php } ?>
								</ul>
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-10">
                                ...
                                <ul id="t1o_product_fb3_content" class="nav nav-tabs">
									<?php foreach ($languages as $language) { ?>
										<li><a href="#t1o_product_fb3_content_<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
									<?php } ?>
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-10">
                                ...
                                <ul id="t1o_product_custom_block_1_content" class="nav nav-tabs">
									<?php foreach ($languages as $language) { ?>
										<li><a href="#t1o_product_custom_block_1_content_<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
									<?php } ?>
								</ul>
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-10">
                                ...
                                <ul id="t1o_product_custom_block_2_content" class="nav nav-tabs">
									<?php foreach ($languages as $language) { ?>
										<li><a href="#t1o_product_custom_block_2_content_<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
									<?php } ?>
								</ul>
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-10">
                                ...
                                <ul id="t1o_product_custom_block_3_content" class="nav nav-tabs">
									<?php foreach ($languages as $language) { ?>
										<li><a href="#t1o_product_custom_block_3_content_<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
									<?php } ?>
								</ul>
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-10">
                                ...
                                <ul id="t1o_product_custom_tab_<?php echo $i; ?>" class="nav nav-tabs">
									<?php foreach ($languages as $language) { ?>
										<li><a href="#t1o_product_custom_tab_<?php echo $i; ?>_<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
									<?php } ?>
								</ul>
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-10">
                                ...
                                <ul id="t1o_fp_fb1_content" class="nav nav-tabs">
									<?php foreach ($languages as $language) { ?>
										<li><a href="#t1o_fp_fb1_content_<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
									<?php } ?>
								</ul>
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-10">
                                ...
                                <ul id="t1o_fp_fb2_content" class="nav nav-tabs">
									<?php foreach ($languages as $language) { ?>
										<li><a href="#t1o_fp_fb2_content_<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
									<?php } ?>
								</ul>
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-10">
                                ...
                                <ul id="t1o_fp_fb3_content" class="nav nav-tabs">
									<?php foreach ($languages as $language) { ?>
										<li><a href="#t1o_fp_fb3_content_<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
									<?php } ?>
								</ul>
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-10">
                                ...
                                <ul id="t1o_fp_fb4_content" class="nav nav-tabs">
									<?php foreach ($languages as $language) { ?>
										<li><a href="#t1o_fp_fb4_content_<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
									<?php } ?>
								</ul>
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-10">
                                ...
                                <ul id="t1o_custom_1_content" class="nav nav-tabs">
									<?php foreach ($languages as $language) { ?>
										<li><a href="#t1o_custom_1_content_<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
									<?php } ?>
								</ul>
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-10">
                                ...
                                <ul id="t1o_powered_content" class="nav nav-tabs">
									<?php foreach ($languages as $language) { ?>
										<li><a href="#t1o_powered_content_<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
									<?php } ?>
								</ul>
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-10">
                                ...
                                <ul id="t1o_custom_2_content" class="nav nav-tabs">
									<?php foreach ($languages as $language) { ?>
										<li><a href="#t1o_custom_2_content_<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
									<?php } ?>
								</ul>
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-10">
                                ...
                                <a href="https://findmyfbid.com/" target="_blank" class="link">Find your Facebook ID &raquo;</a>
							</div>
						</div>
                        <div class="form-group">
							<label class="col-sm-2 control-label">Position:</label>
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-10">
                                ...
                                <ul id="t1o_video_box_content" class="nav nav-tabs">
									<?php foreach ($languages as $language) { ?>
										<li><a href="#t1o_video_box_content_<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
									<?php } ?>
								</ul>
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-10">
                                ...
                                <ul id="t1o_custom_box_content" class="nav nav-tabs">
									<?php foreach ($languages as $language) { ?>
										<li><a href="#t1o_custom_box_content_<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
									<?php } ?>
								</ul>
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-10">
                                ...
                                <ul id="t1o_eu_cookie_message" class="nav nav-tabs">
									<?php foreach ($languages as $language) { ?>
										<li><a href="#t1o_eu_cookie_message_<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
									<?php } ?>
								</ul>
