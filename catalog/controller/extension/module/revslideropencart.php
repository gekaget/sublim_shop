...
// end revsliderfront setting 
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/extension/module/revslideropencart.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/extension/module/revslideropencart.tpl';
		}else{
			$this->template = 'default/template/extension/module/revslideropencart.tpl';
		}
		$this->render();
	}
