...
class ControllerProductCategory extends Controller {
	public function index() {
		...
		$data['t1o_category_img_parallax'] = $this->config->get('t1o_category_img_parallax');
		$data['t1o_category_desc_status'] = $this->config->get('t1o_category_desc_status');
		$data['t1o_category_img_status'] = $this->config->get('t1o_category_img_status');
		$data['t1o_category_subcategories_status'] = $this->config->get('t1o_category_subcategories_status');
		$data['t1o_category_subcategories_style'] = $this->config->get('t1o_category_subcategories_style');
		...
		if ($category_info) {
			...
			foreach ($results as $result) {
			    ...
			    if ($swapimages) {
				    $swapimage = $this->model_tool_image->resize($swapimages[0]['image'], $this->config->get($this->config->get('config_theme') . '_image_product_width'), $this->config->get($this->config->get('config_theme') . '_image_product_height'));
			    } else {
				    $swapimage = false;
			    }
