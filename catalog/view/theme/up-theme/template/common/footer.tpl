...
<?php if(($t1o_fp_fb1_title[$lang]) || ($t1o_fp_fb2_title[$lang]) || ($t1o_fp_fb3_title[$lang]) || ($t1o_fp_fb4_title[$lang])) { ?>
  <div id="features">
  <div class="container">
    <div class="row">

<?php if($t1o_fp_fb1_title[$lang]) { ?>
...
<div class="f-content">
      <span class="f-icon fi1">
        ...
        if ($t1o_fp_fb1_icon != ''){ ?>   
		<img src="<?php echo $path_image . $t1o_fp_fb1_icon ?>" alt="+" title="+">
        <?php } else if($t1o_fp_fb1_awesome !='') { ?>
        <i class="fa fa-<?php echo $t1o_fp_fb1_awesome; ?>"></i>
        <?php } else { ?>
        <i class="fa fa-paper-plane"></i>
		<?php } ?>
      </span>
<span class="f-title"><?php echo $t1o_fp_fb1_title[$lang]; ?></span>
<?php if($t1o_fp_fb1_subtitle[$lang]) { ?>
<span class="f-subtitle"><?php echo $t1o_fp_fb1_subtitle[$lang]; ?></span>
<?php } ?>
</div>
</a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="content-footer-fb">
        <h1><?php echo $t1o_fp_fb1_title[$lang]; ?></h1>
        <p><?php echo $t1o_fp_fb1_subtitle[$lang]; ?></p>
        <?php echo html_entity_decode($t1o_fp_fb1_content[$lang], ENT_QUOTES, 'UTF-8');?>
      </div>
      </div>
    </div>
  </div>
...
<div class="f-content">
      <span class="f-icon fi2">
        ...
        if ($t1o_fp_fb2_icon != ''){ ?>   
		<img src="<?php echo $path_image . $t1o_fp_fb2_icon ?>" alt="+" title="+">
        <?php } else if($t1o_fp_fb2_awesome !='') { ?>
        <i class="fa fa-<?php echo $t1o_fp_fb2_awesome; ?>"></i>
        <?php } else { ?>
        <i class="fa fa-paper-plane"></i>
		<?php } ?>
      </span>
<span class="f-title"><?php echo $t1o_fp_fb2_title[$lang]; ?></span>
<?php if($t1o_fp_fb2_subtitle[$lang]) { ?>
<span class="f-subtitle"><?php echo $t1o_fp_fb2_subtitle[$lang]; ?></span>
<?php } ?>
</div>
</a>
<div class="modal fade" id="modal-fb2" tabindex="-1" role="dialog" aria-labelledby="modal-fb2" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      <div class="content-footer-fb">
        <h1><?php echo $t1o_fp_fb2_title[$lang]; ?></h1>
        <p><?php echo $t1o_fp_fb2_subtitle[$lang]; ?></p>
        <?php echo html_entity_decode($t1o_fp_fb2_content[$lang], ENT_QUOTES, 'UTF-8');?>
      </div>
      </div>
    </div>
  </div>
...
<div class="f-content">
      <span class="f-icon fi3">
        ...
        if ($t1o_fp_fb3_icon != ''){ ?>   
		<img src="<?php echo $path_image . $t1o_fp_fb3_icon ?>" alt="+" title="+">
        <?php } else if($t1o_fp_fb3_awesome !='') { ?>
        <i class="fa fa-<?php echo $t1o_fp_fb3_awesome; ?>"></i>
        <?php } else { ?>
        <i class="fa fa-paper-plane"></i>
		<?php } ?>
      </span>
<span class="f-title"><?php echo $t1o_fp_fb3_title[$lang]; ?></span>
<?php if($t1o_fp_fb3_subtitle[$lang]) { ?>
<span class="f-subtitle"><?php echo $t1o_fp_fb3_subtitle[$lang]; ?></span>
<?php } ?>
</div>
</a>
<div class="modal fade" id="modal-fb3" tabindex="-1" role="dialog" aria-labelledby="modal-fb3" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      <div class="content-footer-fb">
        <h1><?php echo $t1o_fp_fb3_title[$lang]; ?></h1>
        <p><?php echo $t1o_fp_fb3_subtitle[$lang]; ?></p>
        <?php echo html_entity_decode($t1o_fp_fb3_content[$lang], ENT_QUOTES, 'UTF-8');?>
      </div>
      </div>
    </div>
  </div>
...
<div class="f-content">
      <span class="f-icon fi4">
        ...
        if ($t1o_fp_fb4_icon != ''){ ?>   
		<img src="<?php echo $path_image . $t1o_fp_fb4_icon ?>" alt="+" title="+">
        <?php } else if($t1o_fp_fb4_awesome !='') { ?>
        <i class="fa fa-<?php echo $t1o_fp_fb4_awesome; ?>"></i>
        <?php } else { ?>
        <i class="fa fa-paper-plane"></i>
		<?php } ?>
      </span>
<span class="f-title"><?php echo $t1o_fp_fb4_title[$lang]; ?></span>
<?php if($t1o_fp_fb4_subtitle[$lang]) { ?>
<span class="f-subtitle"><?php echo $t1o_fp_fb4_subtitle[$lang]; ?></span>
<?php } ?>
</div>
</a>
<div class="modal fade" id="modal-fb4" tabindex="-1" role="dialog" aria-labelledby="modal-fb4" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      <div class="content-footer-fb">
        <h1><?php echo $t1o_fp_fb4_title[$lang]; ?></h1>
        <p><?php echo $t1o_fp_fb4_subtitle[$lang]; ?></p>
        <?php echo html_entity_decode($t1o_fp_fb4_content[$lang], ENT_QUOTES, 'UTF-8');?>
      </div>
      </div>
    </div>
  </div>
...
<?php if($t1o_information_column_1_status == 1 || $t1o_information_column_2_status == 1 || $t1o_information_column_3_status == 1 || $t1o_custom_1_status == 1) { ?>
  <div id="information" <?php if($t1d_bg_image_f2_parallax == 1) { ?>data-stellar-background-ratio="0.5"<?php } ?>>
  <div class="container">
    <div class="row">
    <?php if($t1o_information_column_1_status == 1) { ?>
      <div class="col-sm-<?php echo 12 / ($t1o_information_column_1_status + $t1o_information_column_2_status + $t1o_information_column_3_status + $t1o_custom_1_status) ; ?>">
        ...
        <ul class="list-unstyled">
          ...
          <?php } ?>
          <?php if($t1o_i_c_1_1_status == 1) { ?><li><a href="<?php echo $sitemap; ?>"><?php echo $text_sitemap; ?></a></li><?php } ?>
        </ul>
        <?php } ?>
      </div>
      <?php } ?>
      ...
      <div class="col-sm-<?php echo 12 / ($t1o_information_column_1_status + $t1o_information_column_2_status + $t1o_information_column_3_status + $t1o_custom_1_status) ; ?>">
        <?php if($t1o_custom_1_title[$lang]) { ?>
        <h5><?php echo $t1o_custom_1_title[$lang]; ?></h5>
        <?php } ?>
        <?php echo html_entity_decode($t1o_custom_1_content[$lang], ENT_QUOTES, 'UTF-8');?>
      </div>
      <?php } ?>
    </div>
  </div>
  ...
  <?php if($t1o_powered_status == 1 || $t1o_news_status == 1 || $t1o_follow_us_status == 1 || $t1o_payment_block_status == 1) { ?>
  <div id="powered">
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-3">
      <?php echo html_entity_decode($t1o_powered_content[$lang], ENT_QUOTES, 'UTF-8');?>  
      </div>
      <?php } ?>
      
      
      <div class="col-sm-6">
      <?php if($t1o_news_status == 1) { ?>
      <span id="footer-news"><?php echo $text_news; ?>:</span>
      <ul id="ticker">
      <?php for ($i = 1; $i <= 10; $i++) { ?>
      <?php if($t1o_news[$i]['status'] == 1 && $t1o_news[$i][$lang]['title'] !='' || $t1o_news[$i]['url'] !='') { ?>                     
        <li>
		  <a href="<?php echo $t1o_news[$i]['url']; ?>">
          <?php echo $t1o_news[$i][$lang]['title']; ?>
          </a>
        </li>
      <?php } ?>
      <?php } ?> 
      ...
      <ul class="list-inline">
        ...
        <i data-toggle="tooltip" data-placement="left" title="<?php echo $text_social; ?>" class="fa fa-share-alt"></i>
          ...
          <ul class="dropdown-menu dropdown-menu-right social-dropdown-menu">
            <?php if($t1o_facebook != '') { ?>
            <li data-toggle="tooltip" title="Facebook" class="col-xs-3 col-sm-3 facebook"><a href="<?php echo $t1o_facebook; ?>" title="Facebook" target="_blank"><i class="fa fa-facebook"></i></a></li>
            <?php } ?>
	        <?php if($t1o_twitter != '') { ?>
            <li data-toggle="tooltip" title="Twitter" class="col-xs-3 col-sm-3 twitter"><a href="<?php echo $t1o_twitter; ?>" title="Twitter" target="_blank"><i class="fa fa-twitter"></i></a></li>
            <?php } ?>
	        <?php if($t1o_googleplus != '') { ?>
            <li data-toggle="tooltip" title="Google+" class="col-xs-3 col-sm-3 google"><a href="<?php echo $t1o_googleplus; ?>" title="Google+" target="_blank"><i class="fa fa-google-plus"></i></a></li>
            <?php } ?>
	        <?php if($t1o_rss != '') { ?>
            <li data-toggle="tooltip" title="RSS" class="col-xs-3 col-sm-3 rrs"><a href="<?php echo $t1o_rss; ?>" title="RSS" target="_blank"><i class="fa fa-rss"></i></a></li>
            <?php } ?>
	        <?php if($t1o_pinterest != '') { ?>
            <li data-toggle="tooltip" title="Pinterest" class="col-xs-3 col-sm-3 pinterest"><a href="<?php echo $t1o_pinterest; ?>" title="Pinterest" target="_blank"><i class="fa fa-pinterest"></i></a></li>
            <?php } ?>
	        <?php if($t1o_vimeo != '') { ?>
            <li data-toggle="tooltip" title="Vimeo" class="col-xs-3 col-sm-3 vimeo"><a href="<?php echo $t1o_vimeo; ?>" title="Vimeo" target="_blank"><i class="fa fa-vimeo-square"></i></a></li>
            <?php } ?> 
	        <?php if($t1o_flickr != '') { ?>
            <li data-toggle="tooltip" title="Flickr" class="col-xs-3 col-sm-3 flickr"><a href="<?php echo $t1o_flickr; ?>" title="Flickr" target="_blank"><i class="fa fa-flickr"></i></a></li>
            <?php } ?>  
	        <?php if($t1o_linkedin != '') { ?>
            <li data-toggle="tooltip" title="LinkedIn" class="col-xs-3 col-sm-3 linkedin"><a href="<?php echo $t1o_linkedin; ?>" title="LinkedIn" target="_blank"><i class="fa fa-linkedin"></i></a></li>
            <?php } ?>
	        <?php if($t1o_youtube != '') { ?>
           <li data-toggle="tooltip" title="YouTube" class="col-xs-3 col-sm-3 youtube"><a href="<?php echo $t1o_youtube; ?>" title="YouTube" target="_blank"><i class="fa fa-youtube-play"></i></a></li>
            <?php } ?>
	        <?php if($t1o_dribbble != '') { ?>
            <li data-toggle="tooltip" title="Dribbble" class="col-xs-3 col-sm-3 dribbble"><a href="<?php echo $t1o_dribbble; ?>" title="Dribbble" target="_blank"><i class="fa fa-dribbble"></i></a></li>
            <?php } ?>
            <?php if($t1o_instagram != '') { ?>
            <li data-toggle="tooltip" title="Instagram" class="col-xs-3 col-sm-3 instagram"><a href="<?php echo $t1o_instagram; ?>" title="Instagram" target="_blank"><i class="fa fa-instagram"></i></a></li>
            <?php } ?>   
            <?php if($t1o_behance != '') { ?>
            <li data-toggle="tooltip" title="Behance" class="col-xs-3 col-sm-3 behance"><a href="<?php echo $t1o_behance; ?>" title="Behance" target="_blank"><i class="fa fa-behance"></i></a></li>
            <?php } ?>   
            <?php if($t1o_skype != '') { ?>
            <li data-toggle="tooltip" title="Skype" class="col-xs-3 col-sm-3 skype"><a href="skype:<?php echo $t1o_skype; ?>" title="Skype" target="_blank"><i class="fa fa-skype"></i></a></li>
            <?php } ?>    
            <?php if($t1o_tumblr != '') { ?>
            <li data-toggle="tooltip" title="Tumblr" class="col-xs-3 col-sm-3 tumblr"><a href="<?php echo $t1o_tumblr; ?>" title="Tumblr" target="_blank"><i class="fa fa-tumblr"></i></a></li>
            <?php } ?>
            <?php if($t1o_reddit != '') { ?>
            <li data-toggle="tooltip" title="Reddit" class="col-xs-3 col-sm-3 reddit"><a href="<?php echo $t1o_reddit; ?>" title="Reddit" target="_blank"><i class="fa fa-reddit"></i></a></li>
            <?php } ?>
            <?php if($t1o_vk != '') { ?>
            <li data-toggle="tooltip" title="VK" class="col-xs-3 col-sm-3 vk"><a href="<?php echo $t1o_vk; ?>" title="VK" target="_blank"><i class="fa fa-vk"></i></a></li>
            <?php } ?>   
          </ul>
        </li>
        <?php } ?>
		...
		<li class="col-xs-4 col-sm-4"><a href="<?php echo $t1o_payment_block_custom_url; ?>" target="_blank">
  ...
  <div class="row">
    <div id="footer_custom_bottom" class="col-sm-12 padd-t-b-30">
      <?php echo html_entity_decode($t1o_custom_2_content[$lang], ENT_QUOTES, 'UTF-8');?>
    </div>
  </div>
  </div>
  </div>
...
<div class="cookie-message hidden-xs">
  ...
  <?php echo html_entity_decode($t1o_eu_cookie_message[$lang], ENT_QUOTES, 'UTF-8');?>
  <a class="my-close-button btn btn-primary" href="#"><?php echo $t1o_eu_cookie_close[$lang]; ?></a>
</div>
<?php } ?>
