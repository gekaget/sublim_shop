<div class="panel panel-default product-module">
  ...
  <div class="product-items product-items-bestseller product-items-<?php echo $t1o_bestseller_style; ?>">
  <?php foreach ($products as $product) { ?>
  <?php if($t1o_bestseller_style ==1) { ?>
...
$('.product-items-bestseller').owlCarousel({
	itemsCustom : [
        [0, 1],
        [980, <?php echo $t1o_bestseller_per_row; ?>],
    ],
	singleItem: false,
	pagination: true,
	navigation: false,
