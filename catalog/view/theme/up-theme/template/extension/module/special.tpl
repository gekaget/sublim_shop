<div class="panel panel-default product-module">
  ...
  <div class="product-items product-items-special product-items-<?php echo $t1o_specials_style; ?>">
  <?php foreach ($products as $product) { ?>
  <?php if($t1o_specials_style ==1) { ?>
...
$('.product-items-special').owlCarousel({
	itemsCustom : [
        [0, 1],
        [980, <?php echo $t1o_specials_per_row; ?>],
    ],
	singleItem: false,
	pagination: true,
	navigation: false,
