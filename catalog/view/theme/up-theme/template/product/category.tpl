...
<?php if($t1o_category_title_position == 0) { ?>
<div id="title_above_content" class="category_top_title" <?php if($thumb) { ?>style="background-image: url(<?php echo $thumb; ?>)<?php } ?>" <?php if($t1o_category_img_parallax == 1) { ?>data-stellar-background-ratio="0.5"<?php } ?>>
<div class="container">
...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>    
      ...
      <?php if(($t1o_category_desc_status == 1) || ($t1o_category_img_status == 1)) { ?>
      <div class="row content-padd">
        <div class="col-sm-<?php if(($t1o_category_desc_status == 1) && ($t1o_category_img_status == 1) && ($thumb)) { ?>7<?php } else { ?>12<?php } ?> cat-description">
          <?php if($t1o_category_title_position == 1) { ?>
          <h1><?php echo $heading_title; ?></h1>
          <?php } ?>
          <?php if(($t1o_category_desc_status == 1) && ($description)) { ?>
          <?php echo $description; ?>
          <?php } ?>    
        </div>
        <?php if(($t1o_category_img_status  == 1) && ($thumb)) { ?>
      ...
      <?php if($t1o_category_subcategories_status == 1) { ?>
      <?php if($t1o_category_subcategories_style == 0) { ?> 
